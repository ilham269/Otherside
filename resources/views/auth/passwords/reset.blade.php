...
@section('title', 'Reset Password — Otherside Store')
...
<div style="min-height:100vh;display:flex;align-items:center;justify-content:center;padding:5rem 1rem 3rem;background:#f8f8f8;">
    <div style="width:100%;max-width:420px;">
        ...
        <div style="text-align:center;margin-bottom:2rem;">
            ...
            <h4 style="font-weight:900;margin-top:.75rem;margin-bottom:.2rem;">Buat Password Baru</h4>
            <p style="font-size:.83rem;color:#999;margin:0;">Masukkan password baru untuk akunmu.</p>
        </div>
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" value="{{ $email ?? old('email') }}"
                        style="width:100%;border:1.5px solid {{ $errors->has('email') ? '#dc2626' : '#e0e0e0' }};border-radius:10px;padding:.6rem .9rem;font-size:.88rem;outline:none;transition:border-color .2s;background:#f8f8f8;"
                ...
                <div class="mb-3">
                    <label style="font-size:.82rem;font-weight:700;display:block;margin-bottom:.35rem;">Password Baru</label>
                    <div style="position:relative;">
                        ...
                        <button type="button" onclick="togglePass('passNew','eyeNew')" tabindex="-1"
        ...
        <p style="text-align:center;font-size:.83rem;color:#999;margin-top:1.25rem;">
            <a href="{{ route('login') }}" style="color:#0a0a0a;font-weight:800;text-decoration:none;">
                <i class="fa-solid fa-arrow-left me-1"></i> Kembali login
            </a>
        </p>
